    ...
    if (this.state.products !== null) {
      return (
        <Grid>
          <Row className="hidden-sm hidden-xs">
            <h1 className="text-center item-title">Just For You</h1>
          </Row>
          <div  className={this.state.condition ? "item-wrapper all-item sidebar-open" :"item-wrapper all-item"}>
            ...
            <SortBar
              ...
              <Col xs={12} md={9} lg={10} className="item-content">
                <h1 className="text-center item-title visible-sm visible-xs">Just For You</h1>
      ...
      return (
        <Grid>
          <div className={this.state.condition ? "item-wrapper all-item sidebar-open" :"item-wrapper all-item"}>
            <Row className="hidden-sm hidden-xs">
              <h1 className="text-center">Just For You</h1>
            </Row>
            <Row>
